 ...
 * Date: 2023 - 10 - 06
 * 
 * A tester to test both functions on colorUtils.c. Use CMocka to
...
int main(int argc, char **argv) {
    ...
    double facebookBlue[] =     {66, 103, 178, 0.63, 0.42, 0.00, 0.30};
    double googleRed[] =        {15, 157, 88, 0.904459, 0, 0.439490, 0.384314};
    double royalBlue[] =        {0, 35, 102, 1, 0.6569, 0, 0.6};
    ...
    const struct CMUnitTest tests[] = { 
            ...
            cmocka_unit_test_prestate(testBidirectionalValues, &googleRed),
            cmocka_unit_test_prestate(testBidirectionalValues, &royalBlue),
  };
